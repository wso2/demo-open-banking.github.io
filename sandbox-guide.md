...
If you want to start from scratch by creating your own application, start from Create an Application. If not, start from the Subscribe APIs section where you can use our default application. 
